...
(function(){
    ...
    // Language — detect instantly for first-time visitors
    ...
    if (!lang) {
        ...
        document.cookie = 'tp_lang=' + lang + ';path=/;max-age=31536000;SameSite=Lax';
    }
    if (lang && lang !== 'ru') {
        document.addEventListener('DOMContentLoaded', function(){
            ...
            // Update title
            var titles = {en:'TOKEN PAY LLC — AI, Fintech & Network Technologies', zh:'TOKEN PAY LLC — AI、金融科技和网络技术'};
