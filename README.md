...
[![API](https://img.shields.io/badge/API-v2.2-black?style=flat-square)](https://tokenpay.space/api/v1/health)
...
[Click to go to the website](https://tokenpay.space/)
...
- **Desktop Integration** — Electron, Tauri, native apps via deep links
- **Multilingual** — Russian, English, Chinese (auto-detect)
...
val authUrl = client.getAuthorizationUrl(scopes = listOf("profile", "email"), usePKCE = true)
```
...
For desktop apps (Electron, Tauri, WPF, Swift) use the system browser OAuth flow:

```
1. Open system browser → https://tokenpay.space/api/v1/oauth/authorize?...
   &redirect_uri=myapp://callback
2. User authenticates in browser
3. Browser redirects → myapp://callback?code=...
4. App catches deep link, exchanges code for token
```

**Desktop parameters:**
```
?theme=dark|light        — match your app theme
&lang=ru|en|zh           — UI language
&redirect_uri=myapp://cb — custom scheme for deep link
```

See full guide: [tokenpay.space/docs#desktop-integration](https://tokenpay.space/docs)

---

## Contributors

- **Ivan Chernykh** — Founder, Lead Developer, Architecture & Implementation
...
© 2025–2026 TOKEN PAY LLC — All Rights Reserved

**Source code is proprietary. This repository contains public API documentation, SDK examples, and integration guides only.**
