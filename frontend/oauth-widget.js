...
(function () {
    ...
    // ─── SVG icon (TOKEN PAY shield icon, inline, no external request) ─────
    var ICON_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>';
    ...
    function _createIconButton(sz, theme) {
        ...
        iconDiv.innerHTML = ICON_SVG;
        iconDiv.style.cssText = 'width:' + sz.iconSz + 'px;height:' + sz.iconSz + 'px;display:flex;align-items:center;justify-content:center;pointer-events:none';
    ...
    function _createLogoButton(sz, theme, lang) {
        ...
        var iconDiv = document.createElement('div');
        iconDiv.innerHTML = ICON_SVG;
        iconDiv.style.cssText = 'width:' + sz.iconSz + 'px;height:' + sz.iconSz + 'px;display:flex;align-items:center;justify-content:center;pointer-events:none;flex-shrink:0';
        iconDiv.querySelector('svg').style.cssText = 'width:100%;height:100%';
